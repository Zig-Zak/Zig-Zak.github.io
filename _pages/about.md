...
<p>
  <a href="{{ '/projects/chebyshev_robot/' | relative_url }}">
    <img src="{{ 'images/projects/Chebyshev/chebyshev_titlew.jpg' | relative_url }}" alt="Chebyshev Robot" style="width:1000px;height:auto;display:inline-block;vertical-align:middle;border-radius:6px;" />
  </a>
</p>
<!--<p>
  <a href="{{ '/projects/chebyshev_robot/' | relative_url }}">
